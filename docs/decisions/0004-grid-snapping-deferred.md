...
produced invalid geometry: two adjacent rooms could round *toward each other*
and overlap, or a room near the usable perimeter could round *outward* and leave
...
Making the *engine* grid-native (snapping the container and every split to
...
to stored coordinates/sizes. The 0.5 m grid becomes a *rendering/serialization*
